...
class SnakeGame:
    ...
    def display_score(self):
        ...
        self.canvas.create_text(50, 10, text=score_text, fill="white", font=("Arial", 10), anchor="nw")
    ...
    def draw(self):
        ...
        self.canvas.create_rectangle(self.food[0], self.food[1], self.food[0] + BLOCK_SIZE, self.food[1] + BLOCK_SIZE, fill=FOOD_COLOR)
        for segment in self.snake:
            self.canvas.create_rectangle(segment[0], segment[1], segment[0] + BLOCK_SIZE, segment[1] + BLOCK_SIZE, fill=SNAKE_COLOR)
